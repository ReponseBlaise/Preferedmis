...
router.post('/attendance/bulk', auth, getUserProjects, authorize('employee', 'manager', 'storeman'), auditLog('CREATE', 'attendance'), attendanceController.recordBulkAttendance);
